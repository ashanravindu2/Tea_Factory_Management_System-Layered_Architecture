...
import lk.captain.view.tm.PaymentSupplierTM;
...
public void initialize() throws SQLException, ClassNotFoundException {
    ...
    void btnPayOnAction(ActionEvent event) throws ClassNotFoundException {
        ...
        if (isValid == true) {
            ...
            try {
                boolean isSaved = paymentBO.addPayement(new PaymentDto(tranCod, suppId, date1, date2, trasacDate, netTotal, netWeight, fertilizer, 0, 0));
                if (isSaved) {
    ...
    @FXML
    void datapicker2OnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
    String date1 = String.valueOf(datepicker1.getValue());
    String date2 = String.valueOf(datapicker2.getValue());
    String suppId = cmbSuppId.getValue();
        double netleaf = teaLeafEntryBO.getNetValue(date1,date2,suppId);
