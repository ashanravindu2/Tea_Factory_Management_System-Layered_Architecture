...
public class GenerateTransactionCode {
    public static String generateTransacId() throws SQLException, ClassNotFoundException {
    ...
    public List<PaymenSuppDetailGetDTO> getAllDetail() throws SQLException, ClassNotFoundException {
        Connection connection =DbConnection.getDbConnection().getConnection();
    ...
    public List<PaymentWorkerDTO> getAllDetailworker() throws SQLException, ClassNotFoundException {
        Connection connection =DbConnection.getDbConnection().getConnection();
    ...
    public List<PaymentWorkerDTO> getAllDetailTeaColec() throws SQLException, ClassNotFoundException {
        Connection connection = DbConnection.getDbConnection().getConnection();
